...
const phases = [
  { src: "/assets/obra-01-terreno.jpg", title: "Preparação do Terreno", desc: "Limpeza e terraplanagem do terreno em Ibiúna", phase: "Fase 1" },
  { src: "/assets/obra-02-terraplanagem.jpg", title: "Terraplanagem", desc: "Nivelamento e preparação do solo para a fundação", phase: "Fase 1" },
  { src: "/assets/obra-03-fundacao.jpg", title: "Fundação e Alvenaria", desc: "Início da construção dos blocos estruturais", phase: "Fase 2" },
  { src: "/assets/obra-04-alvenaria-inicio.jpg", title: "Alvenaria Avançada", desc: "Levantamento das paredes e estrutura do empreendimento", phase: "Fase 2" },
  { src: "/assets/obra-05-estrutura.jpg", title: "Estrutura dos Blocos", desc: "Edificação dos apartamentos tomando forma", phase: "Fase 3" },
  { src: "/assets/obra-06-cobertura.jpg", title: "Cobertura e Telhado", desc: "Finalização da estrutura principal com cobertura", phase: "Fase 3" },
  { src: "/assets/obra-07-paisagismo.jpg", title: "Paisagismo", desc: "Plantio de palmeiras e vegetação tropical", phase: "Fase 4" },
  { src: "/assets/obra-08-lago.jpg", title: "Lago Natural", desc: "Construção do lago ornamental com pedras", phase: "Fase 4" },
  { src: "/assets/obra-09-varanda.jpg", title: "Varandas com Vista", desc: "Acabamento das varandas com vista para a serra", phase: "Fase 5" },
  { src: "/assets/obra-10-piscina.jpg", title: "Área de Lazer", desc: "Construção das piscinas e espaços de convivência", phase: "Fase 5" },
  { src: "/assets/resort-lake.jpg", title: "Lago Finalizado", desc: "Paisagismo concluído com lago natural e cascata", phase: "Entregue ✓" },
  { src: "/assets/resort-pool.jpg", title: "Resort Pronto!", desc: "Ibiunature Aqua Clube 100% operacional", phase: "Entregue ✓" },
];
